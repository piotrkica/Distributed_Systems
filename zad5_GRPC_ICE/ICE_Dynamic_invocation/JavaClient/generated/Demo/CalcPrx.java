...
{
    default int[] sortBuckets(java.util.Map<java.lang.Integer, int[]> buckets)
    {
        return sortBuckets(buckets, com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default int[] sortBuckets(java.util.Map<java.lang.Integer, int[]> buckets, java.util.Map<String, String> context)
    {
        return _iceI_sortBucketsAsync(buckets, context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<int[]> sortBucketsAsync(java.util.Map<java.lang.Integer, int[]> buckets)
    {
        return _iceI_sortBucketsAsync(buckets, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<int[]> sortBucketsAsync(java.util.Map<java.lang.Integer, int[]> buckets, java.util.Map<String, String> context)
    {
        return _iceI_sortBucketsAsync(buckets, context, false);
    }
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<int[]> _iceI_sortBucketsAsync(java.util.Map<java.lang.Integer, int[]> iceP_buckets, java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<int[]> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "sortBuckets", null, sync, null);
        f.invoke(true, context, null, ostr -> {
                     bucketMapHelper.write(ostr, iceP_buckets);
                 }, istr -> {
                     int[] ret;
                     ret = istr.readIntSeq();
                     return ret;
    ...
    default double sumOfRoots(int[] sq)
    {
        return sumOfRoots(sq, com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default double sumOfRoots(int[] sq, java.util.Map<String, String> context)
    {
        return _iceI_sumOfRootsAsync(sq, context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<java.lang.Double> sumOfRootsAsync(int[] sq)
    {
        return _iceI_sumOfRootsAsync(sq, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<java.lang.Double> sumOfRootsAsync(int[] sq, java.util.Map<String, String> context)
    {
        return _iceI_sumOfRootsAsync(sq, context, false);
    }
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<java.lang.Double> _iceI_sumOfRootsAsync(int[] iceP_sq, java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<java.lang.Double> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "sumOfRoots", null, sync, null);
        f.invoke(true, context, null, ostr -> {
                     ostr.writeIntSeq(iceP_sq);
                 }, istr -> {
                     double ret;
                     ret = istr.readDouble();
                     return ret;
    ...
    default void payment(Transaction tr)
    {
        payment(tr, com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default void payment(Transaction tr, java.util.Map<String, String> context)
    {
        _iceI_paymentAsync(tr, context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<Void> paymentAsync(Transaction tr)
    {
        return _iceI_paymentAsync(tr, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<Void> paymentAsync(Transaction tr, java.util.Map<String, String> context)
    {
        return _iceI_paymentAsync(tr, context, false);
    }
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<Void> _iceI_paymentAsync(Transaction iceP_tr, java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<Void> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "payment", null, sync, null);
        f.invoke(false, context, null, ostr -> {
                     Transaction.ice_write(ostr, iceP_tr);
                 }, null);
        return f;
    }
